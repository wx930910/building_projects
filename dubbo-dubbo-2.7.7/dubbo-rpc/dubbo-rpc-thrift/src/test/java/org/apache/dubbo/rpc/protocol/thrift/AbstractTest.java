...
public abstract class AbstractTest {
    ...
    protected TTransportFactory getTransportFactory() {
    	TTransportFactory tTransportFactory = Mockito.mock(TTransportFactory.class);
    	Mockito.when(tTransportFactory.getTransport(Mockito.any(TTransport.class))).thenAnswer(invocation -> {
    		return new TFramedTransport(invocation.getArgument(0)); 
    	});
