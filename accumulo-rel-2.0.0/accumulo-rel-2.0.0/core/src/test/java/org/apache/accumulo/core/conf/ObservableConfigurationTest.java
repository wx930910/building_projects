...
public class ObservableConfigurationTest {
	...
	public void setUp() {
		...
		c = Mockito.spy(ObservableConfiguration.class);
		Mockito.when(c.get(Mockito.any(Property.class))).thenReturn(null);
		Mockito.doNothing().when(c).getProperties(Mockito.anyMap(), Mockito.any());
